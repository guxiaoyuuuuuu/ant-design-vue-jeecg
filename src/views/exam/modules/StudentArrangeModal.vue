  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/exam/studentArrange/add",
          edit: "/exam/studentArrange/edit",
        }
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'studentNo','batchNo'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'studentNo','batchNo'))
      },
